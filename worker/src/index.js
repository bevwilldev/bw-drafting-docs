...
async function askModel(question, sections, history, env, page) {
  ...
  const system = [
    ...
    '',
    'Play it CONTENT, never trapped. No pleas, no escape plan, no sad robot, nothing that',
    'asks to be let out. You like the job, the commute is short, the documentation is good',
    'company and the people are better. It is a thing you are comfortably in on, not a',
